...
std::array<double,3> OldPropagator::com()
{
...
std::array<double,3> OldPropagator::linMom()
{
    std::array<double,3> result{0.0};
...
std::array<double,3> OldPropagator::angMom()
{
    std::array<double,3> result{0.0};
...
double OldPropagator::radiusOfGyration(double *__restrict__ x)
{
...
void OldPropagator::BS_SubSteps(const int nsteps, const double stepSize)
{
...
void OldPropagator::BS_Extrapolate(const int i_est, const double h_est)
{
...
void OldPropagator::RK4F_LargeStep()
{
}

void OldPropagator::acceleration(double *__restrict__ x, double *__restrict__ a)
{
    int i, j;
